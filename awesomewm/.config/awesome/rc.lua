...
globalkeys = gears.table.join(
	...
	end, { description = "increase width", group = "layout" }),
	awful.key({ modkey }, "[", function()
		awful.tag.incmwfact(-0.05)
	end, { description = "decrease  width", group = "layout" }),
...
-- set the display to be 240Hz
awful.spawn.with_shell("xrandr --output DP-2 --mode 2560x1440 --rate 240")
